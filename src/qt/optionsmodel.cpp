...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeFadeAmount"))
        settings.setValue("nAnonymizeFadeAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeFadeAmount = settings.value("nAnonymizeFadeAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeFadeAmount"))
        SoftSetArg("-anonymizeFadeamount", settings.value("nAnonymizeFadeAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeFadeAmount:
            nAnonymizeFadeAmount = value.toInt();
            settings.setValue("nAnonymizeFadeAmount", nAnonymizeFadeAmount);
            emit anonymizeFadeAmountChanged(nAnonymizeFadeAmount);
            break;
        default:
            break;
        }
