...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Fade
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Fade
    // Mac: ~/Library/Application Support/Fade
    // Unix: ~/.Fade
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Fade";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Fade.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Faded.pid"));
