...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 FADE"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 FADE"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 FADE"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 FADE"));
