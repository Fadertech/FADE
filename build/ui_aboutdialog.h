...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Fade", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Fade</b> version", 0));
...
"Copyright \302\251 2014 The Fade developers", 0));
